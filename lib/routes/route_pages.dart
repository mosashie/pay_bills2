...
//import 'package:qrpay/firebase auth/registration_screen.dart';
import 'package:qrpay/firebase auth/auth_screen.dart';
...
//import 'package:qrpay/views/categories/send_money/confirmation_screen.dart';
import 'package:qrpay/views/categories/send_money/send_money_preview_screen.dart';
import 'package:qrpay/views/categories/send_money/country_selection_screen.dart';
...
import '../views/categories/add_money/deposit_country.dart';
...
*/
    ...
    GetPage(
      name: Routes.NewkycFromScreen,
      page: () => NewKycFormScreen(),
    ),
    GetPage(
    ...
    GetPage(
      ...
      page: () =>
          CountrySelectionScreen(), // routes to-> send_money_screen.dart -> recipient_phone_screen.dart -> confirmation_screen.dart internally
    ),
    GetPage(
